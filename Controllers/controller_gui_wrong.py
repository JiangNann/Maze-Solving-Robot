...
#
                ...
                if self.turn_left_for_blind_range(right_free,front_free):
...
#                        when it's more towards left and facing left=> go find the left wall; when it's towards right and facing right=> go find the right wall
                        if (x<7 and self._robot.facing == WEST) or (x>8 and self._robot.facing == EAST):
...
#                print(self._robot.facing,self._robot.center)
#
...
#        print
        ...
        print("original fastest path:")
        print(self._fastest_path)
...
#                    6
            ...
            if blind_unexplored_coors1[0] < 0 and blind_unexplored_coors1[0] > 19 and blind_unexplored_coors1[1] < 0 and blind_unexplored_coors1[1] > 14:
                return False
#                    3
            y2= y
            x2 = x-2
