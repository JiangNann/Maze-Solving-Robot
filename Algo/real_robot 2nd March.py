...
class Robot:
    ...
    def __init__(self, exploration_status, facing, discovered_map):
        ...
        self.sensors = [
            ...
            #         0,1
            #
            {"mount_loc": ES, "facing": EAST, "range": 3, "blind_spot": 0},
            {"mount_loc": ES, "facing": EAST, "range": 3, "blind_spot": 0},
...
#    def _mark_probability_new (self, cell_index, is_obstacle):
#            """
#            No probability calculatioin
#            If cell is detected as obstacle, immediately mark it as obstacle
#            If cell has been marked beforehand, don't override & quite
#            """
#            y, x = get_matrix_coords(cell)
#            print('Current Sesnsor Reading: x, y, count, total: {}'.format((x, y, count, total)))
#
#    #       marked as obstacle before
#            if self.probability_map[y][x][0] == 1.0 and self.probability_map[y][x][1] == 0.0:
#                print('Cell has been marked as permanent non-obstacle')
#                return None, None
#    #       marked as obstacle before
#            elif self.probability_map[y][x][1] == 1.0 and self.probability_map[y][x][0] == 0.0:
#                print('Cell has been marked as permanent non-obstacle')
#                return None, None
#
#            else if
...
#            return None, None
    ...
    def _mark_obstacle(self,cell_index):
        """
    ...
    def _mark_non_obstacle(self, cell):
        """
...
#                   if both out of index, do nothing
                    if to_explore1[0] < 0 or to_explore1[0] > 19 or to_explore1[1] < 0 or to_explore1[1] > 14:
#                        enable_print()
...
#                ---------------------------------------------------------------------------------------------------
            ...
            elif reading == 0 or reading > sensor['range']:
